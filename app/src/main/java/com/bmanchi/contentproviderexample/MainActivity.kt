package com.bmanchi.contentproviderexample
...
//            if (readGranted) {
            if (ContextCompat.checkSelfPermission(this, READ_CONTACTS) == PackageManager.PERMISSION_GRANTED) {
                ...
                Snackbar.make(view, "Please grant contact access permission", Snackbar.LENGTH_INDEFINITE)
...
//                    // Permission was grantes, do the contacts-related task
...
////                    false
//                }
////                findViewById<FloatingActionButton>(R.id.fab).isEnabled = readGranted
//
//            }
//        }
//    }
